...
export class ResponseStatus extends EnumType<ResponseStatus>() {
  ...
  static READ_ALL_RECOMMEND_PAGES_SUCCESS = new ResponseStatus(
    HttpStatus.OK,
    '추천 페이지 목록 조회 성공',
  );
  static READ_EXPLORE_PAGE_SUCCESS = new ResponseStatus(
    HttpStatus.OK,
    '탐색 페이지 상세 조회 성공',
  );
  ...
  static READ_ALL_STOREASY_TEMPLATES_SUCCESS = new ResponseStatus(
    HttpStatus.OK,
    '스토리지 템플릿 목록 조회 성공',
  );
  static READ_STOREASY_TEMPLATE_SUCCESS = new ResponseStatus(
    HttpStatus.OK,
    '스토리지 템플릿 상세 조회 성공',
  );
